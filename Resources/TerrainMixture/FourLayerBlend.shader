Shader "Hidden/TerrainMixture/FourLayerBlend"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float4 mixture(v2f_customrendertexture i) : SV_Target
            {
                ...
                combined.r *= mul3(1 - combined.gba);
                combined.g *= mul3(1 - combined.rba);
                combined.b *= mul3(1 - combined.gra);
                combined.a *= mul3(1 - combined.gbr);
